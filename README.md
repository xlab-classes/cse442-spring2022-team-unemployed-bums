Welcome to our website's Github! The website is currently being run on http://www-student.cse.buffalo.edu:8051/ but you can run also run the website using local host. 
